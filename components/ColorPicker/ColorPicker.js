...
module.exports = class ColorPicker extends Component {
          ...
          <TouchableWithoutFeedback onPress={(x) => this.onDiscPress(c, i)}>
            <Animated.View
              ...
              <View
                style={[
                  ss.wheelImg,
                  { backgroundColor: '#000', opacity: 1 - (i >= 9 ? 1 : (i * 11) / 100) },
                ]}
              />
            </Animated.View>
          </TouchableWithoutFeedback>
  ...
  render() {
    const { style, thumbSize, sliderSize, swatchesLast, swatchesOnly, discrete, row } = this.props;
        ...
        {!swatchesOnly && (
          <View style={[ss.wheel]} key="$1" onLayout={this.onSquareLayout}>
            {this.wheelWidth > 0 && (
              <View
                style={[
                  { padding: thumbSize / 2, width: this.wheelWidth, height: this.wheelWidth },
                ]}>
        ...
        {!swatchesOnly &&
          (discrete ? (
            ...
            <View style={[ss.slider, sliderStyle]} key="$2">
              ...
              <Animated.View
                style={[ss.sliderThumb, sliderThumbStyle, Elevations[4], { pointerEvents: 'none' }]}
              />
              <View
                style={[ss.cover]}
